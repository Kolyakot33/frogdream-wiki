...
При написании `$` у вас начинает работать калькулятор. Пример: $123+42. В сообщении это заменится на результат (165) и будет выделено жёлтым цветом.

## FDWhere

Покажи, где ты находишься, введя `where` в чат. Зелёные координаты - обычный мир, красные - Незер, а фиолетовые - Энд. МП/МФ расшифровываются как Мир Построек и Мир Ферм соответственно.
